...
function NewVideo() {
    ...
    const handleConfirmSave = () => {
        addVideo(formData);
        setNotificationMessage('El video se guardo exitosamente.');
    ...
    return (
        <div className="new-video-page">
            <div className="container__new-video">
                <header className="new-video__header">
                    ...
                    <p className="new-video__description">
                        Complete el formulario para crear una nueva targeta de video
                    </p>
                </header>
            ...
            {showConfirmation && (
                <ConfirmationDialog
                    message={`¿Está seguro de que desea guardar este video?`}
